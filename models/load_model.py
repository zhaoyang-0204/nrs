...
from nrs.models import MODEL_SET
import nrs.models.available_models
...
def get_model(
	...
	if FLAGS.config.has_true_gradient:
		logging.info("True gradient will be applied during training for shake regularization in nrs.")
